...
public class CornerMarkText extends View {
  ...
  public void setText(String text) {
    ...
    if (mLayoutParams != null &&
        ((mLayoutParams.height == ViewGroup.LayoutParams.WRAP_CONTENT || mLayoutParams.height == ViewGroup.LayoutParams.MATCH_PARENT)
        ||( mLayoutParams.width == ViewGroup.LayoutParams.WRAP_CONTENT || mLayoutParams.width == ViewGroup.LayoutParams.MATCH_PARENT))) {
      requestLayout();
    } else {
      invalidate();
    }
  ...
  private void initTextBgPaint() {
    ...
    Log.d(TAG, "----------initTextBgPaint.mText = " + mText + " ,ascent = " + mTextPaint.ascent() + " ,descent = " + mTextPaint.descent());
    Paint.FontMetrics fontMetrics = mTextPaint.getFontMetrics();
    Log.d(TAG, "----------initTextBgPaint.mText = " + mText + " ,bottom = " + fontMetrics.bottom + " ,top = " + fontMetrics.top
  ...
  private int measureSize(int widthMeasureSpec, int heightMeasureSpec) {
    ...
    Log.d(TAG, "-----------measureSize.text = " + mText + " ,width = " + width + " ,height = " + height);
  ...
  private int measureWidth(int measureSpec) {
    ...
    if (widthMode == MeasureSpec.EXACTLY) {
      ...
      Log.d(TAG, "----------measureWidth.widthMode ≠ EXACTLY , mText = " + mText + " ,measureTextWidth = " + (width - 12));
